...
The React renderer and its component registry, shipped precompiled. It reads the tree the
server resolved and draws it; it decides nothing.
...
You configure no bundler. The panel is served as static assets by `@perchjs/nest`.
